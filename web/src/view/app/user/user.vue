  ...
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="日期" prop="createdAt"width="180">
          ...
          <el-table-column label="头像" prop="headImg" width="200">
              <template #default="scope">
                <el-image preview-teleported style="width: 100px; height: 100px" :src="getUrl(scope.row.headImg)" fit="cover"/>
              </template>
          </el-table-column>
    ...
    <el-drawer destroy-on-close :size="appStore.drawerSize" v-model="detailShow" :show-close="true" :before-close="closeDetailShow" title="查看">
            <el-descriptions :column="1" border>
                    ...
                    <el-descriptions-item label="头像">
                            <el-image style="width: 50px; height: 50px" :preview-src-list="returnArrImg(detailFrom.headImg)" :src="getUrl(detailFrom.headImg)" fit="cover" />
                    </el-descriptions-item>
