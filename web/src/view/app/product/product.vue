  ...
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="日期" prop="createdAt"width="180">
          ...
          <el-table-column align="left" label="stock" prop="stock" width="120" />
          <el-table-column align="left" label="类别名称" prop="categoryName" width="120" />
          <el-table-column align="left" label="categoryID" prop="categoryID" width="120" />
           <el-table-column label="imgs" prop="imgs" width="200">
              <template #default="scope">
                 <div class="multiple-img-box">
                    <el-image preview-teleported v-for="(item,index) in scope.row.imgs" :key="index" style="width: 80px; height: 80px" :src="getUrl(item)" fit="cover"/>
                </div>
              </template>
           </el-table-column>
          <el-table-column align="left" label="isDelete" prop="isDelete" width="120" />
    ...
    <el-drawer destroy-on-close :size="appStore.drawerSize" v-model="dialogFormVisible" :show-close="false" :before-close="closeDialog">
       <template #header>
          ...
          <el-form :model="formData" label-position="top" ref="elFormRef" :rules="rule" label-width="80px">
            ...
            <el-form-item label="price:"  prop="price" >
              <el-input v-model.number="formData.price" :clearable="true" placeholder="请输入price" />
            </el-form-item>
            <el-form-item label="supplierID:"  prop="supplierID" >
            ...
            <el-form-item label="stock:"  prop="stock" >
              <el-input v-model.number="formData.stock" :clearable="true" placeholder="请输入stock" />
            </el-form-item>
            <el-form-item label="类别名称:"  prop="categoryName" >
            ...
            <el-form-item label="isDelete:"  prop="isDelete" >
              <el-input v-model.number="formData.isDelete" :clearable="true" placeholder="请输入isDelete" />
            </el-form-item>
          </el-form>
    </el-drawer>
    ...
    <el-drawer destroy-on-close :size="appStore.drawerSize" v-model="detailShow" :show-close="true" :before-close="closeDetailShow" title="查看">
            <el-descriptions :column="1" border>
                    ...
                    <el-descriptions-item label="categoryID">
                        {{ detailFrom.categoryID }}
                    </el-descriptions-item>
                    <el-descriptions-item label="imgs">
                            <el-image style="width: 50px; height: 50px; margin-right: 10px" :preview-src-list="returnArrImg(detailFrom.imgs)" :initial-index="index" v-for="(item,index) in detailFrom.imgs" :key="index" :src="getUrl(item)" fit="cover" />
                    </el-descriptions-item>
                    <el-descriptions-item label="isDelete">
                        {{ detailFrom.isDelete }}
                    </el-descriptions-item>
            </el-descriptions>
        </el-drawer>
