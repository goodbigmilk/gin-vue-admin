    ...
    "paths": {
        ...
        "/purchases/createPurchases": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "创建purchases",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/app.Purchases"
                        }
                    }
                ],
                "responses": {
        ...
        "/purchases/deletePurchasesByIds": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
    ...
    "definitions": {
        ...
        "app.Supplier": {
            ...
            "properties": {
                ...
                "status": {
                    "description": "状态 0合作中，1暂停合作，2黑名单",
                    "type": "integer"
                },
                "supplierID": {
                    "description": "供应商id",
